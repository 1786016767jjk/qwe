...
from .serializer import ShoppingCartSerializers,ShoppingCartDetailSerializers
...
from .serializer import OrderInfoSerializers
    ...
    def perform_create(self, serializer): #添加购物车
        ...
        if gs.goods_num >= serializer.data['nums']:
            ...
            if shopCardGoods :
                ...
                ShoppingCart.objects.create(goods_id=goods_id, nums=serializer.data['nums'],
                                                user = user)
        else:
...
#             return HttpResponseRedirect('http://47.94.241.247:8000/index/')
#         else:
